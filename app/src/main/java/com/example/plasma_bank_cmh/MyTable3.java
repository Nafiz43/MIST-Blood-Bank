...
public class MyTable3 {
    ...
    Context context;
    int c=0;
    public MyTable3(TableLayout tableLayout, Context context){
...
//                textView[i].setBackgroundColor(Color.GREEN);
//            }else{
...
//            }
        ...
        tableRow.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
               Intent intent=new Intent(context,see_all_users_and_edit.class);

                //intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
                intent.putExtra("rowContentsString",stringArray);
                context.startActivity(intent);
                Toast.makeText(context,"Going to detailed information",Toast.LENGTH_SHORT).show();
                return true;
                //      return false;
            }
        });
